                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea  name="title1" class="col-md-12">value="<?=$newData['title1']?></textarea>
                        </div>
                        <div class="col-md-12">
                            <label for="">Sustainability</label>
                            <textarea  name="title1" class="col-md-12">value="<?=$newData['title2']?></textarea>
                        </div>

                        <div class="col-md-12">
                            <label for="">Farmer education</label>
                            <textarea  name="title3" class="col-md-12">value="<?=$newData['title3']?></textarea>
                        </div>
                        <div class="col-md-12">
                            <label for="">Integration</label>
                            <textarea  name="title4" class="col-md-12">value="<?=$newData['title4']?></textarea>
                        </div>
                        <div class="col-md-12">
                            <label for="">Quality and reliability</label>
                            <textarea  name="title5" class="col-md-12">value="<?=$newData['title5']?></textarea>
                        </div>
                        <div class="col-md-12">
                            <label for="">Transparency and security</label>
                            <textarea  name="title6" class="col-md-12">value="<?=$newData['title6']?></textarea>
                        </div>
                        <div class="col-md-12">
                            <label for="">Technical support and customer service</label>
                            <textarea  name="title7" class="col-md-12">value="<?=$newData['title7']?></textarea>
                        </div>
